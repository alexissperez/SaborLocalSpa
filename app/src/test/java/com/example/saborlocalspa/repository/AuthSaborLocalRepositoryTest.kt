...
import com.example.saborlocalspa.data.remote.dto.auth.AuthSaborLocalData
...
import com.example.saborlocalspa.data.remote.dto.common.ApiResponse
import io.mockk.*
...
class AuthSaborLocalRepositoryTest {
    ...
    private lateinit var mockApiService: com.example.saborlocalspa.data.remote.api.SaborLocalAuthApiService
    private lateinit var mockTokenManager: com.example.saborlocalspa.data.local.TokenManager
